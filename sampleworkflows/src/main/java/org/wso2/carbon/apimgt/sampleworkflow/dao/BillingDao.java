 ...
 *
 */
package org.wso2.carbon.apimgt.sampleworkflow.dao;
...
public class BillingDao {
    ...
    /**
     * get the billing dao instance
     * @return BillingDao BillingDao
     * @throws APIManagementException
     */
    public static synchronized  BillingDao getInstance() throws APIManagementException {
        if (instance == null) {
    ...
    private static void createDataSource() throws APIManagementException {
        
        String dataSourceName = "java:comp/env/jdbc/BILLING_DB";
        try {
            Context ctx = new InitialContext();
            dataSource = (DataSource) ctx.lookup(dataSourceName);            
      
        } catch (NamingException e) {
            throw new APIManagementException("Error while looking up the data " + "source: " + dataSourceName, e);
        }
    }
